...
import '../dayComponent/dayComponent.scss';
import { TaskEditorComponent } from '../../taskEditor/taskEditorComponent';
const dayTemplate = require('../dayComponent/dayComponent.hbs');
