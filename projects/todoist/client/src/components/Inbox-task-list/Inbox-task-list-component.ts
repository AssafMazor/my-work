...
import { SectionComponent , eSectionMode } from './section/section-component';

import '../Inbox-task-list/Inbox-task-list-component.scss';
const taskListTemplate = require('../Inbox-task-list/Inbox-task-list-component.hbs');
...
export class InboxTaskListComponent {
    ...
    renderCompletedTasks(completedTasksList){
      ...
      completedTasksList.forEach((task:ITask) => {
        let section = this.sectionsService.getSection(task.data.sectionId);
