...
import { LabelFilterItemComponent , eItemMode } from './label-filter-item/label-filter-item-component';

import '../filters-labels/filters-labels-component.scss';
const filterLabelTemplate = require('../filters-labels/filters-labels-component.hbs');
