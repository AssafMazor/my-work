...
import { addLabelComponent , elabelMode } from '../../add-label/add-label-component';
...
import '../label-filter-item/label-filter-item-component.scss'
const labelFilterItemTemplate = require('../label-filter-item/label-filter-item-component.hbs');
