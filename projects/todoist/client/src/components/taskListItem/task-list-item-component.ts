...
import '../taskListItem/task-list-item-component.scss';
const taskListItemTemplate = require('../taskListItem/task-list-item-component.hbs');
...
export class TaskListItemComponents {
    ...
    constructor(params:ITaskParams){ 
        ...
        this.isTaskHaveChildren = params.task.data.children.length > 0;
    ...
    getLabels(){
        ...
        this.task.data.labels.forEach((labelId:string) => {
