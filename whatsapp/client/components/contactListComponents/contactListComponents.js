...
import {profileComponent} from '../profileComponents/profileComponents.js';
import {chatBackgroundComponent} from '../chatBgColorComponents/chatBgColorComponents.js';
import {ContactBlockListComponent} from '../contactBlockListComponents/contactBlockListComponents.js';
import {selectContactsGroupComponents} from '../selectContactsGroupComponents/selectContactsGroupComponents.js';
...
export class ContactListComponent {
  ...
  setHtml() {
    $.get("./components/contactListComponents/contactListComponents.hbs",(result) => {
