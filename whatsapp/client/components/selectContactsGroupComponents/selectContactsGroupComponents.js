import {addContactItemComponent} from '../addContactItemComponents/addContactItemComponents.js';
...
export class selectContactsGroupComponents {
  ...
  x = [];
    ...
    setHtml() {
      $.get("./components/selectContactsGroupComponents/selectContactsGroupComponents.hbs",(result) => {
